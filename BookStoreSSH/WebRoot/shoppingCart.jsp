...
<!--
	function updateBookAmount(bookId){
		...
		if(pattern.test(bookAmount)){
			location.href = "updateCartAction.action?updateType=update&bookId="+bookId+"&bookAmount="+bookAmount;
		}
	}
	function deleteBook(bookId){
		if(confirm("确定要删除吗？")){
			location.href = "updateCartAction.action?updateType=delete&bookId="+bookId;
		}
	}
	function addOrders(){
		if(confirm("确定要购买吗？")){
			location.href = "ordersManageAction.action?updateType=add";
		}
	}
//-->
</SCRIPT>
